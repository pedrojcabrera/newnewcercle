...
<html lang="es">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url('recursos/style.css', $_SERVER['REQUEST_SCHEME']); ?>">
        <script src="<?= base_url('recursos/jQuery.js', $_SERVER['REQUEST_SCHEME']); ?>"></script>
