            ...
            <div class="container">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control<?php echo $errorPassword ? ' is-invalid' : ''; ?>" name="password" value="<?php echo set_value('password');?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control<?php echo $errorRepetir ? ' is-invalid' : ''; ?>" name="repetir" value="<?php echo set_value('repetir');?>"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control<?php echo $errorTelefono ? ' is-invalid' : ''; ?>" name="telefono" id="telefono"
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
            <div class="container">
                <div class="card-body">
                    <div class="mb-3">
                        <?php
                        $rutaFotoDefaultRelativa = 'fotosUsuarios/sinfoto.jpg';
                        $rutaFotoDefaultFisica = FCPATH . $rutaFotoDefaultRelativa;
                        ?>
                        <label for="foto" class="form-label">Foto del usuario</label>
                        <label for="foto" class="d-inline-block mb-2" style="cursor: pointer;">
                            <?php if (is_file($rutaFotoDefaultFisica)): ?>
                            <img id="previewFotoUsuario" src="<?php echo base_url($rutaFotoDefaultRelativa); ?>" alt="Foto de usuario"
                        ...
                        <small class="d-block text-muted mb-2">Haz clic en la imagen para seleccionar la foto.</small>
                        <input type="file" class="visually-hidden" name="foto" id="foto" value="<?php echo set_value('foto');?>"
                            accept="image/jpeg,image/jpg" placeholder="Seleccione la Foto">
                        <?php if ($errorFoto): ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control<?php echo $errorWeb ? ' is-invalid' : ''; ?>" name="web" id="web" value="<?php echo set_value('web');?>"
                            placeholder="Web">
                        <div class="invalid-feedback">
                            <?php echo $errorWeb;?>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control<?php echo $errorEnlaces ? ' is-invalid' : ''; ?>" name="enlaces" id="enlaces" value="<?php echo set_value('enlaces');?>"
                            rows="5"></textarea>
                        <div class="invalid-feedback">
            ...
            <div class="d-flex justify-content-between mx-3 mt-3">
                <a name="cancelar" id="cancelar" class="btn btn-success btn-md bi bi-box-arrow-left"
                    href="<?php echo base_url('control/usuarios');?>" role="button" title="Cancelar"> Cancelar</a>
                <button type="submit" class="btn btn-primary btn-md bi bi-check-lg" title="Agregar"> Grabar nuevo usuario</button>
            </div>
        </div>
    </div>
</form>
