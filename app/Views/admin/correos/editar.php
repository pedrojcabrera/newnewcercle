                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="border rounded">
                            ...
                            <div id="textoEditor" class="form-control border-0 rounded-0" contenteditable="true" style="min-height: 22rem; overflow-y: auto;"></div>
                        </div>
                        <textarea class="d-none" name="texto" id="texto" rows="15"><?php echo $correo->texto; ?></textarea>
                    </div>
                </div>
